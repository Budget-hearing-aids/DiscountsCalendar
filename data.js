...
const discountData = {
    "October": [
        ...
        { start: "2024-10-31", end: "2024-10-31", description: "Halloween sale $40 off (Atom 2 Series)" }
    ],
    "November": [
    ...
    "December": [
        { start: "2024-12-02", end: "2024-12-04", description: "Final Sale: 20% off all products - Cyber Monday" },
